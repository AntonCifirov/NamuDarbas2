...
*/
void Failo_rusiavimas_list_2str(list<duom>& asmuo_list, list<duom>& varg_list) //dirba su struktura duom
{
...
duom eilutes_nuskaitymas_duom(ifstream& kursiokai, int nd_sk)
{
    duom asmuo;
...
void Failo_nuskaitymas(string failo_pavadinimas, list<duom>& asmuo1) {
    ...
    for (int i = 0; i < stud_sk; i++)
    {
        asmuo1.push_back(eilutes_nuskaitymas_duom(kursiokai, nd_sk));
    }
